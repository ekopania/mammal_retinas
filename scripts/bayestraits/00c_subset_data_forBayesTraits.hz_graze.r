...
#For data with high certainty only, include eco_certain, eco_certain2, eco_certain3, ret_certain
eco_keep<-Reduce(intersect, list(eco_noMissing, eco_noMissing2, eco_noMissing3))
...
write.nexus(tree_keep, file=paste0(tree,"_hzAny_",eco_cat,".",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,".nexus"))
write.table(newdata, file=paste0("hzAny_",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,"_",tree,".noMissingData.txt"), col.names=FALSE, row.names=TRUE, quote=FALSE, sep="\t")
...
#clean up retinal structure names to have no spaces
#End with ".certainOnly.nexus" if filtering on data certainty
write.nexus(tree_keep, file=paste0(tree,"_hzOnly_",eco_cat,".",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,".nexus"))
write.table(newdata, file=paste0("hzOnly_",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,"_",tree,".noMissingData.txt"), col.names=FALSE, row.names=TRUE, quote=FALSE, sep="\t")
