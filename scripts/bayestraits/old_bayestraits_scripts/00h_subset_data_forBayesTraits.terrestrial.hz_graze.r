...
keep<-Reduce(intersect, list(retina_noMissing, eco_noMissing_sp, eco_certain_sp, eco_noMissing2_sp, eco_certain2_sp, eco_noMissing3_sp, eco_certain3_sp, mytree$tip.label, ret_certain)) #ret_certain
...
write.nexus(tree_keep, file=paste0(tree,"_hzAny_",eco_cat,".",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,".certainOnly.terrestrial.nexus"))
write.table(newdata, file=paste0("hzAny_",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,"_",tree,".noMissingData.certainOnly.terrestrial.txt"), col.names=FALSE, row.names=TRUE, quote=FALSE, sep="\t")
...
rownames(newdata)<-retina_keep$Hub_Species
#clean up retinal structure names to have no spaces
write.nexus(tree_keep, file=paste0(tree,"_hzOnly_",eco_cat,".",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,".certainOnly.terrestrial.nexus"))
write.table(newdata, file=paste0("hzOnly_",eco_trait,"_",eco_cat2,".",eco_trait2,"_",eco_cat3,".",eco_trait3,"_",tree,".noMissingData.certainOnly.terrestrial.txt"), col.names=FALSE, row.names=TRUE, quote=FALSE, sep="\t")
